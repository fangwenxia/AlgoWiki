...
for family in algorithm_families:
	...
	if count==0:
		parsed_text = parsed_text + '| rowspan="'+str(count+1)+'" | Exponential/Factorial\n'
	else:
		parsed_text = parsed_text + '| rowspan="'+str(count)+'" | Exponential/Factorial\n'
	...
	#Use Cases
	parsed_text = parsed_text + '== Application Domains =='
	parsed_text = parsed_text + '\n'
	parsed_text = parsed_text + problem_description
